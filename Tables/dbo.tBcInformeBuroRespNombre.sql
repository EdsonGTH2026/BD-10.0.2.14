CREATE TABLE [dbo].[tBcInformeBuroRespNombre] (
  ...
  CONSTRAINT [PK_tBcInformeBuroRespNombre] PRIMARY KEY CLUSTERED ([IdInforme])
)
ON [PRIMARY]
GO

GRANT SELECT ON [dbo].[tBcInformeBuroRespNombre] TO [public]
GO