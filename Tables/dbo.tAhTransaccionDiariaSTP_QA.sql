CREATE TABLE [dbo].[tAhTransaccionDiariaSTP_QA] (
  ...
  [InstitucionOperante] [int] NULL CONSTRAINT [DF__tAhTransa__Insti__2E1BDC42_QA] DEFAULT (90646),
  [Monto] [money] NULL,
  ...
  [Enviado] [tinyint] NULL CONSTRAINT [DF__tAhTransa__Envia__2F10007B_QA] DEFAULT (0),
  ...
  [numTrans] [int] NULL,
  CONSTRAINT [PK__tAhTransaccionDi__2D27B809_QA] PRIMARY KEY CLUSTERED ([IdTransaccion])
)
ON [PRIMARY]
GO