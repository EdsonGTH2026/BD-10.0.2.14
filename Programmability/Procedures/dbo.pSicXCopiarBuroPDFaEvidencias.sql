...
GO
create procedure [dbo].[pSicXCopiarBuroPDFaEvidencias] (@RutaArchivoOrigen varchar(50), @CodOficina varchar(3), @CodSolicitud varchar(20), @IdTipoDocumento int, @Resultado varchar(10) output)
as
BEGIN
	set nocount off
