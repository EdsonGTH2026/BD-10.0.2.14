...
GO
CREATE PROCEDURE [dbo].[pCCAPI_CrearRespuestaCuentaCC] (@IdCC INT, @FechaActualizacion VARCHAR(10), @RegistroImpugnado VARCHAR(4), 
...
AS
BEGIN
	INSERT INTO tCcRespuestaCuenta (IdCC, FechaActualizacion, RegistroImpugnado, ClaveOtorgante, NombreOtorgante, CuentaActual, TipoResponsabilidad, 
