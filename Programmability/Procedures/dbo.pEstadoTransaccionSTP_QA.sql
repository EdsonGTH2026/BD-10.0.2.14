...
CREATE PROCEDURE [dbo].[pEstadoTransaccionSTP_QA]
(@IdSTP       INT, 
	@estado      VARCHAR(20), 
	@detalle     VARCHAR(20), 
	@empresa     VARCHAR(20), 
	...
	ELSE
		...
		IF @EstadoRes = 'liquidacion' ---liquidacion
			BEGIN
				...
				EXEC Finmas_20200615ini.dbo.pAhRetiroCuentaSPEI @CodCuenta, @Monto, '98CSM1803891', @IdSTP, @folioOrigen;
				
				UPDATE Finmas_20200615ini.dbo.tahcuenta
				SET idEstadoCta = 'CA'
				WHERE codcuenta = @CodCuenta
