...
GO
CREATE PROCEDURE [dbo].[pSDValidaRecMontosMayoresPesos](@Codigo VARCHAR(25), @MontoDeposito MONEY, @CodSistema VARCHAR(3), 
...
BEGIN
	...
	BEGIN
		...
		IF @GenerarAlerta = 1
			BEGIN
				INSERT INTO tAlertasRecMontosMayoresPesosPLD (Codigo, Monto, CodUsuario, NombreCliente, RptaRegla, CodSistema, CodOficina, FechaSistema)
				SELECT a.CodPrestamo, @MontoDeposito, a.CodUsuario, b.NombreCompleto, 1, @CodSistema, @CodOficina, GETDATE()
