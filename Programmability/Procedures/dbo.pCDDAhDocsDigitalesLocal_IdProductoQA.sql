...
GO
create procedure [dbo].[pCDDAhDocsDigitalesLocal_IdProductoQA] (@IdProducto varchar(3))
as
BEGIN
	...
	from finmas_QA.dbo.tahevento as e with(nolock)
	inner join finmas_QA.dbo.taheventoevidencia as ee with(nolock) on ee.IdEvento = e.IdEvento
	where ee.Activa = 1
