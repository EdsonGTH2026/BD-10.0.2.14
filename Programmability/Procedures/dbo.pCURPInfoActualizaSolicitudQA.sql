...
GO
CREATE PROCEDURE [dbo].[pCURPInfoActualizaSolicitudQA] @CodUsuario VARCHAR(50), @CURPValido BIT, @Nombres VARCHAR(100), @ApellidoPaterno VARCHAR(50), 
