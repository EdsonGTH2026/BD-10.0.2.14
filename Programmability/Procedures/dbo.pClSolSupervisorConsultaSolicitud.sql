...
create procedure [dbo].[pClSolSupervisorConsultaSolicitud](@IdSolicitud int)
as
BEGIN
	--Ver. 19-01-2021
	...
	sp.CURP, sp.FechaNacimiento, sp.NumCelular,  
	...
	where sp.IdSolicitudPromotor = @IdSolicitud
