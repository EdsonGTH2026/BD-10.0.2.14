...
GO
CREATE PROCEDURE [dbo].[pSDValidaLimiteDepositosEfectivoV2](@Codigo VARCHAR(25), @MontoDeposito MONEY, @CodSistema VARCHAR(3), 
		 												    @CodOficina VARCHAR(4), @SecuenciaPago NUMERIC(18,0),
...
BEGIN
	...
	ELSE*/
		BEGIN
			...
			ELSE
				BEGIN
					SELECT @FraccionCuenta = a.FraccionCta, @Renovado = a.Renovado, @CodUsuario = a.CodUsTitular
